...
<div class="page-wrapper chiller-theme toggled">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            <a href="#">
              ...
              <span style="font-size:13px;">Transient</span>
            </a>
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="userview/reservation.php" target="myIframe">Reservation</a>
                </li>
              </ul>
            </div>
          </li>-->
    ...
    <div class="sidebar-footer">
      ...
      <<a href="#Changepass" data-toggle="modal">
        <i class="fa fa-key"> <span id="FooA">Change Password</span> </i>
      ...
      <a href="logout.php">
        <i class="fa fa-power-off" title="Log Out"> <span id="FooB"> Logout</span> </i>
      </a>
  ...
  <main class="page-content">
    ...
    <iframe src="userview/announcement.php"class="embed-responsive-item" name="myIframe" allowfullscreen></iframe>
