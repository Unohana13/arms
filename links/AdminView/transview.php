...
<body>
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'];?>">
      ...
      $pages = new Paginator;
			$pages->default_ipp = 10;
			$sql_forms = $mysqli->query("SELECT * FROM transient INNER JOIN tenant ON tenant.Tenant_Id=transient.Tenant_Id");
			$pages->items_total = $sql_forms->num_rows;
			$pages->mid_range = 9;
			$pages->paginate();

			$result	=	$mysqli->query("SELECT * FROM transient INNER JOIN tenant ON tenant.Tenant_Id=transient.Tenant_Id ORDER BY tenant.Tenant_Name ASC ".$pages->limit."");
    }
		?>
								...
								<div class="modal-content">
									<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
										...
										<div class="modal-body">
									        ...
									        <div class="caption">
									          <p>Requested by <Strong><?php echo mb_strtoupper($val['Tenant_Name']); ?></Strong></p>
									        </div>
