...
if(isset($_POST['Addm'])){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO useraccount (username, password, accounttype) VALUES (?, ?, ?)";

        if($stmt = $mysqli->prepare($sql)){
            // Bind variables to the prepared statement as parameters
            $stmt->bind_param("sss", $param_username, $param_password, $param_accounttype);
            ...
            if($stmt->execute()){
                ...
                echo "<script>alert('Operator added successfully');</script>";
                header("location: welcome.php");
            } else{
...
<head>
  ...
  <script> let cells = Array.prototype.slice.call(document.querySelectorAll(".row_data1"));
  // Loop over the array
...
<body>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          ...
          <div class="modal-body">
            <div class="form-group <?php echo (!empty($new_password_err)) ? 'has-error' : ''; ?>">
                ...
                <label>New Password <span class="badge badge-info">Format : 6 characters, no spaces</span></label>
          ...
          <div class="modal-footer">
                ...
                <a class="btn btn-link" href="Admin.php">Cancel</a>
                <input type="submit" class="btn btn-success" value="Submit" name="changep">
  ...
  <div id="AddOperator" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>" required>
                <label>Password</label>
                <input type="password" name="password" class="form-control" value="<?php echo $password; ?>" pattern="[^ ]+.{5,}">
                <span class="help-block"><?php echo $password_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label>Confirm Password</label>
                <input type="password" name="confirm_password" class="form-control" value="<?php echo $confirm_password; ?>" pattern="[^ ]+.{5,}">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            <a href="#">
              ...
              <span style="Font-size:13px;">Information</span>
            </a>
    ...
    <div class="sidebar-footer">
      ...
      <a href="#Changepass" data-toggle="modal">
        <i class="fa fa-key"> <span style="Font-family:calibri;">Change Password</span></i>

      </a>

      <a href="#AddOperator" data-toggle="modal">
        <i class="fa fa-plus-square"> <span style="Font-family:calibri;">Add account </span></i>
      </a>
      <a href="logout.php">
        <i class="fa fa-power-off" title="Log Out"> <span style="Font-family:calibri;">logout</span>  </i>
      </a>
