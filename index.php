...
<div class="building_text">
  <div>
      <h2> Makati Apartment Details</h2>
  </div>
</div>
<!-- location2 -->
...
$mail->MsgHTML($content);
  ...
  if(!$mail->Send()) {
    echo "<script>$('#ModalMessageNotSuccess').modal('hide')</script>";
    var_dump($mail);
  } else {
  echo "<script>$('#ModalMessageSuccess').modal('hide')</script>";
  }
