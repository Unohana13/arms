  ...
  <div id="mylocation1" class="carousel slide" data-ride="carousel" style="top:-29px;">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="Carouselpic\location1\dining.png" alt="first pic" style="width:950px; height:500px; margin:auto;">
      </div>
      <div class="item">
        <img src="Carouselpic\location1\bedroom.png" alt="Second pic" style="width:960px; height:500px; margin:auto;">
      </div>
      <div class="item">
        <img src="Carouselpic\location1\bath.png" alt="third pic"  style="width:960px; height:500px; margin:auto;">
      </div>
      <div class="item">
        <img src="Carouselpic\location1\floorplan.png" alt="Fourth pic" style="width:960px; height:500px; margin:auto;">
      </div>
      <div class="item">
        <img src="Carouselpic\location1\aptDetails.png" alt="Fifth pic" style="width:960px; height:500px; margin:auto;">
      </div>
    </div>
...
<div id="mylocation2" class="carousel slide" data-ride="carousel" style="top:-29px;">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="Carouselpic\bedroom2.png" alt="first pic" style="width:960px; height:500px; margin:auto;">
      </div>
      <div class="item">
        <img src="Carouselpic\location1\dining.png" alt="Second pic" style="width:960px; height:500px; margin:auto;">
      </div>
      <div class="item">
        <img src="Carouselpic\location1\bath.png" alt="third pic"  style="width:960px; height:500px; margin:auto;">
      </div>
...
<!-- location3 -->
  <div id="mylocation3" class="carousel slide" data-ride="carousel" style="top:-29px;">
    <!-- Indicators -->
    <ol class="carousel-indicators">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="Carouselpic\bedroom.png" alt="first pic" style="width:960px; height:500px; margin:auto;">
      </div>
      <div class="item">
        <img src="Carouselpic\location1\dining.png" alt="Second pic" style="width:960px; height:500px; margin:auto;">
      </div>
...
<div class="building_text">
  <div>
      <h1> Location 3  Building Details</h1>
  </div>
  <div>
     <p>Address: Pasig City</p>
     <p>Income Requirment: Must have 2x the rent in the total household income</p>
     <p>Pets: No pets are allowed</p>
     <p>Fee: $150 per aparment</p>
     <p>Rent: $45 for 1 per/month, $40 for 2pets/months</p>
  </div>
</div>
<br></br>
-->
