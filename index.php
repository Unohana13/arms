...
<br></br>
<!-- location1 -->
  <div id="mylocation1" class="carousel slide" data-ride="carousel" style="top:30px;">
    <!-- Indicators -->
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4" style="display:flex;">
      ...
      <h4 style="font-size:24px; margin-bottom:10px; font-family:roboto;">FREE WIFI</h4>
    ...
    <div class="col-sm-4" style="display:flex;">
      ...
      <div style="margin-left:10px;">
      <h4 style="font-size:24px; margin-bottom:10px; font-family:roboto;">Cover with CCTV</h4>
    ...
    <div class="col-sm-4" style="display:flex;">
      ...
      <div style="margin-left:10px;">
      <h4 style="font-size:24px; margin-bottom:10px; font-family:roboto;">Free Parking</h4>
...
<div id="mylocation2" class="carousel slide" data-ride="carousel" style="top:30px;">
    <!-- Indicators -->
    <ol class="carousel-indicators">
...
<!-- location3 -->
<div id="mylocation3" class="carousel slide" data-ride="carousel" style="top:30px;">
    <!-- Indicators -->
    <ol class="carousel-indicators">
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    ...
    <div class="col-sm-4" style="display:flex;">
      ...
      <div style="margin-left:10px;">
      <h4 style="font-size:30px; margin-bottom:10px; font-family:robo;">Free Parking</h4>
      <p class="amme">The building has a large space for tenants with vehicle.</p>
      </div>
    </div>
  </div>
